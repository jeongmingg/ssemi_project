...
------------------------------------------------------
INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R1', 'M2', '맛있어요맛있어', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4.5, 4.5, 4, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R2', 'M2', '와 여기 진짜 맛있어요!! 완전추천 재방문의사 100%!!!', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 5, 4.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R3', 'M3', '음식은 진짜 맛있는데 좀 비싸네요ㅠㅠ 가격에서 별점 조금 뺐어요', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 2.5, 3, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R4', 'M5', '맛, 가격 괜찮은데 서비스가 좀.. 아쉬워요 불친절한 느낌이였어요 그래도 맛은 굿!', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 4, 2.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R5', 'M4', '가성비 굿', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 4, 5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R1', 'M2', '다음에 또 올게요! 맛있어요', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 4.5, 3, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R2', 'M2', '서울오면 여기 맨날 와야지~~', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 4.5, 4, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R3', 'M3', '좀 비싸도 맛있어서 좋아요', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 2.5, 3.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R4', 'M5', '맛있어요~ 인생맛집!', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 5, 4.5, 3.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R5', 'M4', '가성비가 진짜 미쳤어요 최고!!', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4.5, 5, 4.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R1', 'M2', '맛있어요 여자친구랑 와야지', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4.5, 4.5, 4.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R2', 'M2', '존맛이요~~', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 4, 4, 4.5, DEFAULT);

INSERT INTO REVIEW
VALUES('RV'||SEQ_RVNO.NEXTVAL, 'R3', 'M3', '좀 비싸여ㅠㅠ 맛은 좋아용', SYSDATE, SYSDATE, DEFAULT, DEFAULT, DEFAULT, 5, 3.5, 4, DEFAULT);
------------------------------------------------------
-- BOARD TABLE INSERT
------------------------------------------------------
INSERT INTO BOARD 
