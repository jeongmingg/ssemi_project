...
CREATE TABLE RVLIKE (
    ...
    CONSTRAINT RVL_RVNO_FK FOREIGN KEY (REVIEW_NO) REFERENCES REVIEW(REVIEW_NO)
);

COMMENT ON COLUMN RVLIKE.REVIEW_NO IS '리뷰번호';
COMMENT ON COLUMN RVLIKE.NICKNAME IS '닉네임';
