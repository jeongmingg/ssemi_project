...
<body>
      ...
      <div class="container" width="82%">
        <ul id="navi" class="nav nav-tabs nav-justified">
          ...
          <li class="nav-item">
            <a href="<%= contextPath %>/memList.ad" class="nav-link" style="color: orange; font-size: 30px;">Member</a>
            <ul>
              <li align="center"><a href="<%= contextPath %>/memList.ad">회원전체조회</a></li>
            </ul>
          </li>
          <li class="nav-item">
            <a href="<%= contextPath %>/list.bo?cpage=1" class="nav-link" style="color: orange; font-size: 30px;">Board</a>
            <ul>
