<%@page import="com.kh.search.model.vo.Search"%> <%@page
import="com.kh.rest.model.vo.Rest"%> <%@page import="java.util.ArrayList"%> 
                ...
                <div class="wrap">
                    ...
                    <div id="content_1">
                      ...
                      <div id="function">
                        ...
                        <div id="function_content">
                          <input type="checkbox" id="pk" /><label for="pk"
                            >&nbsp;&nbsp;주차</label
                          >
                          <input type="checkbox" id="24" /><label for="24"
                            >&nbsp;&nbsp;24시</label
                          >
                          <input type="checkbox" id="er" /><label for="er"
                            >&nbsp;&nbsp;개별룸</label
                          >
                          <input type="checkbox" id="br" /><label for="br"
                            >&nbsp;&nbsp;대형룸</label
                          >
                          <input type="checkbox" id="dt" /><label for="dt"
                            >&nbsp;&nbsp;드라이브 스루</label
                          >
                          <input type="checkbox" id="an" /><label for="an"
                            >&nbsp;&nbsp;반려동물 동반</label
                          >
                        </div>
                      </div>
                            ...
                            <table id="rest-table" align="center">
                              ...
                              <tr>
                                ...
                                >
                                  ...
                                  %>개)&nbsp;&nbsp;|&nbsp;&nbsp;<img
                                    id="heart"
                                    src="resources/star, heart/heart.png"
                                  />&nbsp; <%= s.getHeart() %>
                                </td>
                              </tr>
                              <tr>
                  ...
                  <script>
                    $(function () {
                      ...
                      // x버튼 누르면 지역버튼 없어지기
                      $("#lc-name-btn a").click(function(){
                    	 $("#lc-name-btn").css("visibility", "hidden"); 
                      });
                    });
                    ...
                    $(document).ready(function () {
                      ...
                      selectBox.on("click", function () {
                        optionList.css(
                          "max-height",
                          "optionList.css('max-height') === '900px' ? '0px' : '900px'"
                        );
                    ...
                    function updateTable(result) {
                      ...
                      $.each(result, function (index, restaurant) {
                        var value =
                          ...
                          "</tr>" +
                          "<tr>" +
                          '<td colspan="2" style="padding-left: 15px; font-size: 20px;"> <img id="star" src="' +
                          restaurant.starImg +
                          '">' +
                          "&nbsp;&nbsp;" +
                          restaurant.restAvg +
                     ...
                     restRqBtn.on("click", function () {
                      if (loginUser === null) {
                          ...
                          window.location.href =
                            "<%= contextPath %>/loginForm.me";
                        });
                      } else {
                        restRqBtn.on("click", function () {
                          window.location.href =
                            "<%= contextPath %>/listForm.bo";
                        });
                      }
                    }); 
